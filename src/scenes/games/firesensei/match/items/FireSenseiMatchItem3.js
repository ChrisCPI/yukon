...
export default class FireSenseiMatchItem3 extends FireSenseiMatchItem {
    ...
    constructor(scene, x, y) {
        ...
        // bg
        const bg = scene.add.image(9, 7, "firesensei", "match/slot3/bg");
        this.add(bg);

        // maskImage
        const maskImage = scene.add.image(0, 0, "firesensei", "match/slot3/mask");
        maskImage.visible = false;
        this.add(maskImage);

        // penguin
        const penguin = new FireSenseiMatchPenguin(scene, 8, 10);
        penguin.scaleX = -1;
        penguin.scaleY = 1;
        ...
        // username
        const username = scene.add.text(7, 75, "", {});
