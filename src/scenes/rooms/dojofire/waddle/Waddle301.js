...
export default class Waddle301 extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // done1
        const done1 = new SeatPoint(scene, -41, 66);
        done1.visible = false;
        this.add(done1);

        // done0
        const done0 = new SeatPoint(scene, -164, 22);
        done0.visible = false;
        this.add(done0);

        // seat1
        const seat1 = new SeatPoint(scene, 44, 10);
        seat1.visible = false;
        this.add(seat1);

        // seat0
        const seat0 = new SeatPoint(scene, -50, -24);
        seat0.visible = false;
        this.add(seat0);
