...
export default class Waddle200 extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // mat
        const mat = scene.add.image(0, 0, "dojohide", "mat/mat_1");
        mat.setOrigin(0.502283105022831, -0.24285714285714285);
        this.add(mat);

        // done1
        const done1 = new SeatPoint(scene, 57, -16);
        done1.visible = false;
        this.add(done1);

        // done0
        const done0 = new SeatPoint(scene, -42, -16);
        done0.visible = false;
        this.add(done0);

        // seat1
        const seat1 = new SeatPoint(scene, 67, 42);
        seat1.visible = false;
        this.add(seat1);

        // seat0
        const seat0 = new SeatPoint(scene, -60, 41);
        seat0.visible = false;
        this.add(seat0);
