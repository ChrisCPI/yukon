...
export default class Waddle203 extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        // mat
        const mat = scene.add.image(0, 0, "dojohide", "mat/mat_3");
        this.add(mat);

        // done1
        const done1 = new SeatPoint(scene, 30, -77);
        done1.visible = false;
        this.add(done1);

        // done0
        const done0 = new SeatPoint(scene, -70, -77);
        done0.visible = false;
        this.add(done0);

        // seat1
        const seat1 = new SeatPoint(scene, 54, -14);
        seat1.visible = false;
        this.add(seat1);

        // seat0
        const seat0 = new SeatPoint(scene, -77, -14);
        seat0.visible = false;
        this.add(seat0);
